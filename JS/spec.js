  ...
  const APP_CONFIG = {
    ...
    tables: {
      ...
      "DIG PROD": { id: "dig_prod", dbTable: "dig_prod", title: "DIG PROD", columns: [
        { name: "PRODUKTNAMN", field: "produktnamn", type: "text", key: true, width: "32ch", digprodCategories: ["B2B-intro", "B2C-intro"], mods: { align: "left", displayMode: "text", readonly: true } },
        ...
        { name: "TEXT COPY", field: "text_copy", type: "status", width: "12ch", digprodCategories: ["B2B-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
        { name: "BILD", field: "bild", type: "status", width: "9ch", digprodCategories: ["B2B-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
        { name: "COPY TO B2C", field: "copy_to_b2c", type: "status", width: "13ch", digprodCategories: ["B2B-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
        ...
        { name: "MILJÖ", field: "miljo", type: "status", width: "9ch", digprodCategories: ["B2C-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
        ...
        { name: "MEDIA", field: "media", type: "status", width: "9ch", digprodCategories: ["B2C-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
        { name: "UPDATE B2B", field: "update_b2b", type: "status", width: "12ch", digprodCategories: ["B2C-intro"], statusLabel: " ", hideStatusLabel: true, mods: { align: "center", readonly: false }, default: "gray" },
